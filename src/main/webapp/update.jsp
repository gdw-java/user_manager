    ...
    <body>
        ...
        <form action="/updateUser?id=${user.id}" method="post">
          ...
          <div class="form-group">
            <label for="address">籍贯：</label>
             <select name="address" class="form-control" >
                <option value="广东"<c:if test="${user.address=='广东'}">
                                    selected="selected"
                                    </c:if> >广东</option>

                <option value="广西" <c:if test="${user.address=='广西'}">
                    selected="selected"
                </c:if>>广西</option>
                <option value="湖南"<c:if test="${user.address=='湖南'}">
                    selected="selected"
                </c:if>>湖南</option>
            </select>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" value="${user.qq}" class="form-control" name="qq" placeholder="请输入QQ号码" readonly="readonly"/>
          </div>

          <div class="form-group">
            <label for="email">Email：</label>

            <input type="text" value="${user.email}" class="form-control" name="email" placeholder="请输入邮箱地址" readonly="readonly"/>
          </div>
