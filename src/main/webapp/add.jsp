...
<div class="container text-left">
    ...
    <form action="/addUser" method="post" class="form-horizontal">
        ...
        <div class="form-group">
           ...
           <span class="erroMsg" style="color: red">${msg} </span>
           <div class="col-lg-8">
               <input type="" class="form-control" id="email" name="email" placeholder="请输入邮箱地址"/>
           </div>
        </div>
 ...
 /*       $(function () {
            $(".form-horizontal").submit(function () {
                    ...
                    $.post("/addUser",data,function (result) {
                        if (result.addFlag) {
                            $(".erroMsg").text(result.msg)
                        }else{
                            location.href="add_ok.jsp"
                        }
